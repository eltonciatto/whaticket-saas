  ...
  const theme = createTheme(
    {
      ...
      palette: {
        type: mode,
        primary: { main: mode === "light" ? "#012489" : "#013EA0" },
        textPrimary: mode === "light" ? "#012489" : "#FFFFFF",
        borderPrimary: mode === "light" ? "#012489" : "#013EA0",
        ...
        options: mode === "light" ? "#012489" : "#013EA0",
        ...
        barraSuperior: mode === "light" ? "linear-gradient(to right, #012489, #012489)" : "#013EA0",
