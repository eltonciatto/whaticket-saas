    ...
    const theme = createTheme(
        {
            ...
            palette: {
                type: mode,
                primary: { main: mode === "light" ? "#012489" : "#012489" },
textPrimary: mode === "light" ? "#012489" : "#FFFFFF",
borderPrimary: mode === "light" ? "#012489" : "#012489",
dark: { main: mode === "light" ? "#1A1A1A" : "#E0E0E0" },
light: { main: mode === "light" ? "#F3F3F3" : "#1A1A1A" },
tabHeaderBackground: mode === "light" ? "#E5E5E5" : "#444444",
...
barraSuperior: mode === "light" ? "linear-gradient(to right, #012489, #012489)" : "#444444",
